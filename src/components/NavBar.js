...
import { XIcon, GithubIcon, LinkedInIcon, DribbbleIcon, PinterestIcon, SunIcon, MoonIcon } from './icons';
    ...
    return (
        ...
        '>
            <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
                <span className={`bg-dark dark:bg-light block transition-all duration-300 ease-in-out h-0.5 w-6 rounded-sm ${isOpen ? 'rotate-45 translate-y-1' : '-translate-0.5'}`}></span>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                <nav>
                    <CustomLink href="/" title="Home" className='mr-4 no-underline'/>
