...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    p-12 dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4
    '>
...
const projects = () => {
  return (
    <>
      <Head>
        <title>matheusd.santosr | Projects Page</title>
        <meta name="description" content="A collection of projects I've worked on." />
      </Head>
      <TransitionEffect />
